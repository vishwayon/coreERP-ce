 ...
 * @author Girish
 */
class GstPymtEventHandler extends \app\core\ac\base\VoucherBaseEventHandler {
    ...
    public function afterFetch($criteriaparam) {
        ...
        if ($this->bo->voucher_id == "" or $this->bo->voucher_id == "-1") {
            ...
            $this->bo->annex_info->Value()->pymt_type = 1;
        } else {
    ...
    public function onNamedMethod($cn, $trantable) {
        ...
        if ($trantable->tableID == 'rl_head_tran') {
            if ($this->bo->ref_no != '') {
                ...
                $cmm->setParamValue('pcredit_amt', $this->bo->annex_info->Value()->bill_amt);
