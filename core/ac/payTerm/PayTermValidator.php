...
/**
 * Description of PayTermValidator
 *
 * @author Kaustubh
 */
class PayTermValidator extends \app\cwf\vsla\xmlbo\ValidatorBase {
    
    public function validatePayTermEditForm() {
    ...
    private function validateBusinessRules() {
        ...
        $cmm->setCommandText('Select pay_term from ac.pay_term where pay_term = :ppay_term and pay_term_id != :ppay_term_id');
