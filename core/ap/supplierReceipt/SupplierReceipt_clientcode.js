...
(function (core_srec) {
    ...
    core_srec.afterload_wiz = afterload_wiz;
    ...
    core_srec.total_calc = total_calc;


    function pl_tran_delete() {
        total_calc();
    }
    core_srec.pl_tran_delete = pl_tran_delete;
    ...
    core_srec.fc_changed = fc_changed;
    ...
    core_srec.adv_alloc_click = adv_alloc_click;
