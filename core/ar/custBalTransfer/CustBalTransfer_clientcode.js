...
(function (core_cbt) {
    ...
    core_cbt.fc_changed = fc_changed;
    ...
    core_cbt.total_calc = total_calc;
    ...
    core_cbt.test_afterload_wiz = test_afterload_wiz;
    
    function rl_tran_delete() {
        total_calc();
    }
    core_cbt.rl_tran_delete = rl_tran_delete;
    ...
    core_cbt.adv_alloc_click = adv_alloc_click;
    ...
    core_cbt.target_branch_filter = target_branch_filter;
}(window.core_cbt));
