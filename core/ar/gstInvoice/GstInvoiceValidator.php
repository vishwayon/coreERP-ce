...
/**
 * Description of GstInvoiceValidator
 *
 * @author priyanka
 */
class GstInvoiceValidator extends \app\cwf\vsla\xmlbo\ValidatorBase {
    
    public function validateGstInvoiceEditForm() {
    ...
    protected function validateBusinessRules() {        
        // GST Invoice allowed to create after 01 Jul, 2017
        if(strtotime($this->bo->doc_date) < strtotime('2017-07-01')){
            $this->bo->addBRule('Not allowed to create GST Invoice before 01 Jul, 2017.');
        }
        ...
        if($this->bo->vat_type_id == -1 || $this->bo->annex_info->Value()->gst_output_info->customer_state_id == -1) {
            $this->bo->addBRule('Failed to determine GST state of Customer and/or Invoice GST Type.');
        }
