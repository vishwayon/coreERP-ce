 ...
 * @author Kaustubh
 */
class MrtnValidator extends \app\core\st\base\StockBaseValidator {

    public function validateMrtnEditForm() {
    ...
    public function validateBeforeStage(\app\cwf\vsla\workflow\WfOption $wfOption) {
        ...
        if ($this->bo->doc_stage_id == 'issued' && $wfOption->doc_action == \app\cwf\vsla\workflow\DocWorkflow::WF_REJECT) {
        ...
        if ($this->bo->doc_stage_id == 'book-return' && $wfOption->next_stage_id == 'issued') {
