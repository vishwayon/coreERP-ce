...
/**
 * Description of StockPurchaseValidator
 *
 * @author Kaustubh
 */
class PurchaseReturnValidator extends \app\core\st\base\StockBaseValidator {

    public function validatePurchaseReturnEditForm() {
    ...
    protected function validateBusinessRules() {
        ...
        If (strtotime($this->bo->doc_date) < strtotime($this->bo->sp_date)) {
            $this->bo->addBRule('Purchase Return Date cannot be less the Stock Purchase Date [' . $this->bo->sp_date . ']');
        }
