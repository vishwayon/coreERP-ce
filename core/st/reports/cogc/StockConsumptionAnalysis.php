...
namespace app\core\st\reports\cogc;
use \YaLinqo\Enumerable;
/**
 * Description of StockConsumptionAnalysis
 *
 * @author girish
 */
class StockConsumptionAnalysis extends \app\cwf\fwShell\base\ReportBase {
    ...
    public function onRequestReport($rptOption) {
        // validate rptOptions->rptParams here
    }
}
