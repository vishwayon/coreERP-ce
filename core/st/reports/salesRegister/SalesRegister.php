...
namespace app\core\st\reports\salesRegister;
/**
 * Description of Sales Register
 *
 * @author Shrishail
 */
class SalesRegister extends \app\cwf\fwShell\base\ReportBase {
    ...
    public function onRequestReport($rptOption) {
        ...
        if($rptOption->rptParams["preg_type"] == "saleReg") {
            $rptOption->rptName = "SaleRegisterV2";
        } elseif ($rptOption->rptParams["preg_type"] == "retReg") {
            $rptOption->rptName = "SaleRegisterReturnV2";
        }
        ...
        if($rptOption->rptParams["pvat_type_id"] == '' || $rptOption->rptParams["pvat_type_id"] == -1) {
            ...
            $rptOption->rptParams["pvat_type_desc"] = \app\cwf\vsla\utils\LookupHelper::GetLookupText(
                    '../core/tx/lookups/VatTypeSale.xml', 
                    'vat_type_desc', 
                    'vat_type_id', 
