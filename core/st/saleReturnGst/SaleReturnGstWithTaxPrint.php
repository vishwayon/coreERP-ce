 ...
 * @author Priyanka
 */
class SaleReturnGstWithTaxPrint extends \app\cwf\fwShell\base\ReportBase {
    ...
    public function onRequestReport($rptOption) {
        ...
        $cmm->setCommandText("Select (a.annex_info->>'dcn_type')::Int as dcn_type, 
                                Case (a.annex_info->>'dcn_type')::Int
                                    ...
                                    coalesce((a.annex_info->>'srr_id')::Int,-1) as srr_id, coalesce(b.srr_desc,'') as srr_desc
                            From st.stock_control a
                            left join st.srr b on (a.annex_info->>'srr_id')::Int = b.srr_id
        ...
        if (count($dt->Rows()) == 1) {
            $rptOption->rptParams["psr_reason"] = $dt->Rows()[0]['srr_desc'];
        }
        return $rptOption;
    }
