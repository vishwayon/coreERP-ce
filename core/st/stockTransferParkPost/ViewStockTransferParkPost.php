...
$viewerurl = '?r=core%2Fst%2Fstock-transfer-park-post%2Fgetdata';
$purl = '?r=core%2Fst%2Fstock-transfer-park-post%2Fsetdata';
$status_option = array();
...
<div id="contentholder"  class="view-min-width view-window1">
    <div id="contents" style="padding: 5px;margin:5px;">
        <script type="application/javascript" src="<?php echo \app\cwf\vsla\utils\ScriptHelper::registerScript('@app/core/st/stockTransferParkPost/StockTransferParkPost_clientcode.js') ?>"></script>
        <script type="application/javascript" src="<?php echo \app\cwf\vsla\utils\ScriptHelper::registerScript('@app/core/st/stockTransfer/StockTransfer_clientcode.js') ?>"></script>
        <div id="collheader" class="row">
            <h3>Stock Transfer/Received</h3>
        </div>
            ...
            <table id="vch_tran" class="row-border hover tran"  cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <th style="width:150px;">Target Branch</th>
                        <th style="width:150px;">Received On</th>
                        <th style="width:150px;">QC Test</th>
        ...
        <script id="stparkpostdata-template" type="text/html">
            <tr> 
                ...
                <td data-bind="text: target_branch"/>
                <td data-bind="dateValue: doc_date"/>
                <td data-bind="text: qc_status"/>
                <td class="">
                    <button id="btn_post" class=" btn simple-button" style="margin:0; padding:2px 10px; border:1px solid lightgrey;" data-bind="click: function() {core_st.core_stocktransferparkpost.post_stpp($data) }">...</button>
                </td>
                <!--<td class="">
