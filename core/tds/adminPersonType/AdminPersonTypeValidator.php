...
namespace app\core\tds\adminPersonType;


/**
 * Description of AdminPersonTypeValidator
 *
 * @author Priyanak
 */
class AdminPersonTypeValidator extends \app\cwf\vsla\xmlbo\ValidatorBase {
    
    public function validateAdminPersonTypeEditForm() {
