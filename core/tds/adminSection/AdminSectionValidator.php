...
namespace app\core\tds\adminSection;


/**
 * Description of AdminSectionValidator
 *
 * @author Priyanka
 */
class AdminSectionValidator extends \app\cwf\vsla\xmlbo\ValidatorBase {
    
    public function validateAdminSectionEditForm() {
