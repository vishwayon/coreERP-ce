<div class="row" id="rptrow7" style="margin:0;border-top: 1px solid grey;">
    <div style="margin-top:5px;"> 
        <form class="col-md-12" id="reqgstr2a" name ="reqgstr2a" style="margin-left:0;">
            ...
            <input type="hidden" id="gst_ret_id" class="textbox form-control" name="gst_ret_id" 
                   type="text" data-bind="value:gst_ret_id" disabled="true">
            ...
            <input type="file" id="gstr_resp_file" name="gstr_resp_file" class="btn btn-sm btn-default col-md-3"
                   accept=".json"/>
            <a id="cmd_uploadgstr2a" class="btn btn-sm btn-default col-md-2" style="margin-left: 20px;" onclick="core_tx.gstr2aReco.upload2a_click();">
                Upload File
            </a>
            <a id="cmd_view_gstr2a_reco" class="btn btn-sm btn-default col-md-2" style="margin-left: 20px;" onclick="core_tx.gstr2aReco.view_gstr2a_reco_click();">
                View Reconciliation
            </a>
