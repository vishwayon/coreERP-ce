...
class ModelPendingDocs {
    ...
    public function getData() {
        ...
        if ($this->doc_action_id == 'O') {
            $cmmtext = "select a.doc_id, 'Saved' as doc_sender_comment, a.user_id_created as user_id_from, a.last_updated::date as doc_sent_on,
            ...
            $cmmtext = "select a.doc_id, a.doc_sender_comment, a.user_id_from, a.doc_sent_on::date, a.doc_action, 
