...
<html lang="<?= Yii::$app->language ?>" style="min-height: 100%;height: 100%;">
    ...
    <body>
        ...
        <div>
            ...
            $ismobile = ($mdetect->isMobile() && !$mdetect->isTablet());
        ...
        <div class="wrap">
            ...
            if (!$ismobile) {
                NavBar::begin([
                    ...
                    . '<small id="sfver" style="font-size: 50%; position: relative;left: 160px;top: 26px; color: #9d9d9d;">'
                ...
                if ($companyname != '' && $companyname !== NULL) {
                    if (\app\cwf\vsla\security\SessionManager::getInstance()->getUserInfo()->isAdmin() || \app\cwf\vsla\security\SessionManager::getInstance()->getUserInfo()->isOwner()) {
                        echo Html::a(
                                $companyname . '&nbsp&nbsp&nbsp<small>'
                                . $branchname
                        ...
                        echo Html::a(
                                $companyname . '&nbsp&nbsp&nbsp<small>'
                                . $branchname
                                . ($finyear === '' ? '' : (' (FY: ' . $finyear . ')')) . '</small>', '?r=/cwf/fwShell/main/switchsession', ['class' => 'navbar-brand',
                            'style' => 'margin-left: 20px; font-weight: normal; '
                            . 'padding-left: 0px; padding-top: 15px; padding-bottom: 0px;']);
                    }
                }
                echo '</span>';
                if ($companyname != '' && $companyname !== NULL) {
                    $searchInput = Html::input('text', 'srchVchId', '', ['id' => 'srchVchId', 'class' => 'form-control', 'placeholder' => 'Search Document', 'style' => 'margin-top:0 !important']);
                    ...
                    'items' => [
                        ['label' => '<span class="glyphicon glyphicon-home"></span>',
                            ...
                            'options' => ['data-toggle' => 'tooltip',
                                'data-placement' => 'tooltip', 'title' => 'Home'],
                            'visible' => (isset($sessionid) && $sessionid !== NULL)],
                        ['label' => '<span class="glyphicon glyphicon-info-sign"></span>',
                            'url' => ['/site/about'],
                            'options' => ['data-toggle' => 'tooltip',
                                'data-placement' => 'tooltip', 'title' => 'About'],
                            'linkOptions' => ['id' => 'myabout', 'name' => 'myabout']],
                        ['label' => '<span class="glyphicon glyphicon-phone-alt"></span>',
                            'url' => ['/site/contact'],
                            'options' => ['data-toggle' => 'tooltip',
                                'data-placement' => 'tooltip', 'title' => 'Support'],
                            'linkOptions' => ['id' => 'mycontact', 'name' => 'mycontact']],
                        ['label' => '<span class="glyphicon glyphicon-user"></span> ' . mb_strimwidth($full_user_name, 0, 10),
                            'url' => ['#'],
                            'options' => ['data-toggle' => 'tooltip',
                                'data-placement' => 'tooltip', 'title' => $full_user_name],
...
//                            'linkOptions' => ['data-method' => 'post', 'id' => 'mainlogout', 'name' => 'mainlogout','onclick' => 'coreWebApp.applogout()']] :
                            ...
                            'options' => ['data-toggle' => 'tooltip',
                                'data-placement' => 'tooltip', 'title' => 'Login'],
            ...
            .navbar-header a{padding: 15px 0 0 0;margin-top: 0;margin-left:30px;}
            .wrap .container{padding-left: 15px !important;}
        </style>';
                NavBar::begin([
                ...
                echo Nav::widget([
                    ...
                    'items' => [
                        ...
                        app\cwf\vsla\security\SessionManager::getAuthStatus() ?
                            ...
                            'options' => ['data-toggle' => 'tooltip',
                                'data-placement' => 'tooltip', 'title' => 'Logout'],
                            'linkOptions' => ['data-method' => 'post', 'id' => 'mainlogout', 'name' => 'mainlogout']] :
                                ['label' => '<span class="glyphicon glyphicon-log-in"></span>',
                            'options' => ['data-toggle' => 'tooltip',
                                'data-placement' => 'tooltip', 'title' => 'Login'],
                            'url' => yii\helpers\Url::home(),
                ...
                NavBar::end();
                echo '<div id="maincontainer" class="container mycontainer" style="padding-top: 50px !important;">';
                echo $content;
                echo '<div id="workspace" class="row">
                                <div class="col-md-10 col-xs-12" id="content-root" 
                                ...
                                <div id="doc-comment" class="col-md-2" ></div>
                            </div>
                        </div>';
            }
            ?>
...
<?php
if ($user_id != -1) {
    //echo 'setInterval(coreWebApp.keepAlive, 300000);';        
