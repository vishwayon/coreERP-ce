...
<div id="workspace" class="row">
    <div class="col-md-2" id="mysidemenu" style="padding-right: 0px;overflow: auto; background-color: #2c383b;">
        <?php echo $content; ?>
    </div>
    <div class="col-md-10" id="content-root" 
    ...
    <div id="doc-comment" class="col-md-2" >
