...
<head>
	...
	<meta name="created" content="2018-09-14T14:07:50.170659966"/>
	<meta name="changed" content="2018-09-14T14:15:07.806202799"/>
	<style type="text/css">
		@page { margin: 2cm }
...
<h1 class="western">Privacy Policy of Vishwayon Software Pvt Ltd</h1>
<p>Vishwayon Software Pvt Ltd operates the <i>coreerp.in</i> website,
which provides the ERP service.</p>
<p>This page is used to inform website visitors regarding our
policies with the collection, use, and disclosure of Personal
Information if anyone decided to use our Service, the coreerp.in
website.</p>
...
<p>The terms used in this Privacy Policy have the same meanings as in
our Terms and Conditions, which is accessible at <i>coreerp.in</i>,
unless otherwise defined in this Privacy Policy.</p>
<h2 class="western">Information Collection and Use</h2>
<p>For a better experience while using our Service, we may require
you to provide us with certain personally identifiable information,
including but not limited to your name and email id. The information
that we collect will be used to contact or identify you.</p>
<h2 class="western">Log Data</h2>
<p>We want to inform you that whenever you visit our Service, we
...
<p>Cookies are files with small amount of data that is commonly used
...
drive.</p>
<p>Our website uses these “cookies” to collection information and
...
use some or all portions of our Service.</p>
<h2 class="western">Service Providers</h2>
<p>We may employ third-party companies and individuals due to the
following reasons:</p>
<ul>
	<li/>
<p style="margin-bottom: 0cm">To facilitate our Service; 
	</p>
	<li/>
<p style="margin-bottom: 0cm">To provide the Service on our
	behalf; 
	</p>
	<li/>
<p style="margin-bottom: 0cm">To perform Service-related
	services; or 
	</p>
	<li/>
<p>To assist us in analysing how our Service is used. 
	</p>
</ul>
<p>We want to inform our Service users that these third parties have
access to your Personal Information. The reason is to perform the
tasks assigned to them on our behalf. However, they are obligated not
to disclose or use the information for any other purpose.</p>
<h2 class="western">Security</h2>
...
<p>Our Service may contain links to other sites. If you click on a
...
that we will be able to do necessary actions.</p>
